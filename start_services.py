...
def stop_existing_containers():
    ...
    # Same for the extra Ollama instances, so they are stopped too
...
def start_local_ai():
    ...
    # Included whenever the file exists - unlike the GPU pinning overrides this
    # is not gated on a *_GPU_DEVICES variable.
    ollama_instances_compose_path = "docker-compose.ollama-instances.yml"
    if os.path.exists(ollama_instances_compose_path):
